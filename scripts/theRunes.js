...
theRunes[2] = {
				...
				'tooltip' : "<strong>BJARKAN - Birch</strong><p><strong>Other names:</strong> Beorc, Berkanan, Bairkan, Bercna, Berkana, Berkano</p><p><strong>Color:</strong><span style='Color: darkgreen'> Dark Green</span></p><p><strong>Elements:</strong> Earth</p><p><strong>Polarity:</strong> Female </p><p><strong>Associated gods:</strong> Holda </p>"
},
theRunes[3] = {
				'image' : 'g4804.png',
				'name': 'DAEG',
...
theRunes[8] = {
				'image' : 'g4809.png',
				'name': 'HAGALL',
				'descriptions' : '<p>Some information about the Rune and how it pertains to the viewers fate.</p>',
